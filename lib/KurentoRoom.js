...
function Stream(kurento, local, room, options) {
    ...
    var that = this;
    console.log("new Stream options:",options);
    that.room = room;
    ...
    function onDataChannelOpen(event) {
        ...
        // TODO убрать тестирование высылки данных отсюда
        console.log("sending to webRtcPeer test data ...");
        console.log("localStream:",that);
        console.log("webRtcPeer:",that.getWebRtcPeer());
        that.getWebRtcPeer().send("test");
    }
